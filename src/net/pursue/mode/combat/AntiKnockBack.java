...
public class AntiKnockBack extends Mode {
    ...
    public final BooleanValue<Boolean> sendC03 = new BooleanValue<>(this, "(1.8+)SendC03",false, () -> modeValue.getValue().equals(mode.GrimReduce));
    public final BooleanValue<Boolean> sendC06 = new BooleanValue<>(this, "(1.17+)SendC06",false, () -> modeValue.getValue().equals(mode.GrimReduce));
                ...
                case GrimReduce: {
                    if (entityLivingBase != null) {
                        if (!mc.player.serverSprintState) {
                            if (sendC06.getValue()) mc.player.connection.sendPacket(new CPacketPlayer(mc.player.onGround));
