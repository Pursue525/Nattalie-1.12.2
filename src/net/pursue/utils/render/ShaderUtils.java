...
public class ShaderUtils {
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                ...
                case "gaussian":
                    ...
                    break;
                case "gaussian_bloom":
                    fragmentShaderID = createShader(new ByteArrayInputStream(gaussian_bloom.getBytes()), GL_FRAGMENT_SHADER);
                    break;
                default:
    ...
    String gradientMask = "#version 120\n" +
            "\n" +
    ...
    String gaussian_bloom = "#version 120\n" +
            "\n" +
            "uniform sampler2D inTexture, textureToCheck;\n" +
            "uniform vec2 texelSize, direction;\n" +
            "uniform float radius;\n" +
