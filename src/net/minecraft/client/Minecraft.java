...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    public void displayGuiScreen(@Nullable GuiScreen guiScreenIn) {
        ...
        EventManager.instance.call(new EventScreen(guiScreenIn));
    ...
    public void sendClickBlockToController(boolean leftClick)
    {
        ...
        if (this.leftClickCounter <= 0 && !this.player.isHandActive())
        {
            if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == RayTraceResult.Type.BLOCK)
            {
                ...
                {
                    EventManager.instance.call(new EventClickBlock(this.objectMouseOver.getBlockPos(), this.objectMouseOver.sideHit));
    ...
    private void runTickKeyboard() throws IOException
    {
        while (Keyboard.next())
        {
            ...
            if (flag) {
                Nattalie.instance.getModeManager().getEnableMods().forEach(mod -> mod.key(i));

                Nattalie.instance.getModeManager().onKey(i);
