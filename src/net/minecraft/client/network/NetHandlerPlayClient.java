...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    {
        EventPacket packetSent = new EventPacket(packetIn);
    ...
    public void handleCustomPayload(SPacketCustomPayload packetIn)
    {
        ...
        if (Nattalie.instance.getModeManager().getByClass(Protocol.class).isEnable()) {
            ...
            } else if (packetIn.getChannelName().equalsIgnoreCase("germplugin-netease")) {
                Wrapper.runOnMainThread(() -> Protocol.germModPacket.process(packetIn.getBufferData()));
            } else if (packetIn.getChannelName().equals("VexView")) {
                Protocol.vexViewWrapper.processVewView(packetIn);
            }
        }
