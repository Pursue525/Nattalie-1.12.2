...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (isSprint && Sprint.instance.modeValue.getValue().equals(Sprint.mode.None) || isSprint && (Sprint.instance.modeValue.getValue().equals(Sprint.mode.V1_14_High) && (!this.isInWater() && !this.isInLava())) || isSprint && (Sprint.instance.modeValue.getValue().equals(Sprint.mode.V1_14_Low) && !(this.movementInput.field_192832_b < 0.8F || this.isCollidedHorizontally))) {
            ...
            if (this.isSprinting() && (this.movementInput.field_192832_b < 0.8F || this.isCollidedHorizontally)) {
    ...
    public void moveEntity(MoverType x, double p_70091_2_, double p_70091_4_, double p_70091_6_)
    {
        double d0 = this.posX;
        double d1 = this.posZ;
        EventMove e = EventManager.instance.call(new EventMove(x, p_70091_2_, p_70091_4_, p_70091_6_));
        super.moveEntity(e.getMoverType(), e.getX(), e.getY(), e.getZ());
    ...
    public Vector2f getRotation() {
        return new Vector2f(this.mc.player.rotationYaw, this.mc.player.rotationPitch);
    }
}
