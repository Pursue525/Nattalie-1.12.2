...
public class GuiProtocolSelector extends GuiScreen {
    ...
    class SlotList extends GuiSlot {
        ...
        @Override
        protected void func_192637_a(int i, int i1, int i2, int i3, int i4, int i5, float p_192637_7_) {
            drawCenteredString(mc.fontRendererObj,(ViaLoadingBase.PROTOCOLS.indexOf(ViaLoadingBase.getInstance().getTargetVersion()) == i ? TextFormatting.GREEN.toString() + TextFormatting.BOLD : TextFormatting.GRAY.toString()) + ViaLoadingBase.getProtocols().get(i).getName(), width / 2, i2 + 2, -1);
            GlStateManager.pushMatrix();
